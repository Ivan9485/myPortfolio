    ...
    <div name='contact' className="bg-secondary w-full h-screen flex justify-center items-center p-4">
      <form method="POST" className="flex flex-col max-w-[600px] w-full" action="https://getform.io/f/2aa01697-fb58-4d1e-9309-cb2069325785">
        <div className="pb-8">
          ...
          <p className="text-textdef py-4 flex">Envíame un mensaje! o contactame por <p className="text-emerald-500 px-2 hover:text-emerald-400"><a target="_blank" rel="noopener noreferrer" href="https://wa.me/528688182504/?text=Quiero%20más%20información%20sobre%20catálogo:%20">Whatsapp</a></p></p>
        </div>
